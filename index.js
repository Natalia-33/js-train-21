...
class Musician {
  static count = 0;
  #name;
  #instrument; // статичне поле count, яке відслідковує кількість музикантів, початкове значення 0
  // Об'являємо приватні поля #name; #instrument;

  constructor(name, instrument) {
    this.#name = name;
    this.#instrument = instrument; // Конструктор приймає два параметри: name та instrument
